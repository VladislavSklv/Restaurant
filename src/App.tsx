...
function App() {
	...
	return (
		<Routes>
			{products !== undefined && <Route path='/' element={<MainMenuPage isCart={isCart} setIsCart={setIsCart} totalPrice={totalPrice} vendorId={productProps.vendorId} productsTabs={products} />} />}
