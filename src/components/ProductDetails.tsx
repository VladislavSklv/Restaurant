...
const ProductDetails:React.FC<productDetailsProps> = ({products, isDetails, detailsId, setIsDetails, setIsOpacity, isCart, setIsCart, companyId}) => {
	...
	const mainBtn = () => {
		if(isDetails === false){
			setIsCart(true);
			navigate(`/cart/?companyId=${companyId}`);
		} else {
